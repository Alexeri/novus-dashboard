...
const Profile = ({ type, name, avatar, email, properties }: ProfileProps) => (
  <Box>
    <Typography fontSize={28} fontWeight={800} color="#11142D">{type} Profile</Typography>
    ...
    >
      ...
      >
        ...
        <img
          src="https://images.unsplash.com/photo-1585854467604-cf2080ccef31?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1173&q=80"
          width={340}
          height={320}
          alt="abstract"
              ...
              <Stack direction="column" gap="30px">
                <Stack gap="15px">
                  ...
                  <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                    ...
                    <Typography fontSize={14} color="#11142D">Kaptensgatan 2, Stockholm, 149 31</Typography>
                  </Box>
                </Stack>
