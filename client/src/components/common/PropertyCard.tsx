...
import { Place, Scale } from '@mui/icons-material'
...
const PropertyCard = ({ id, title, location, price, photo} : PropertyCardProps) => {
  return (
    ...
    >
      ...
      />
      <CardContent sx={{display: "flex", flexDirection:"row", justifyContent:"space-between", gap:"10px", paddingX: "5px", paddingY:"12px !important", alignItems:"center"}}>
