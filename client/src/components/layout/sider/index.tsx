          ...
          >
            <ListItemButton
              ...
              sx={{
                ...
                "&.Mui-selected": {
                  "&:hover": {
                    backgroundColor: isSelected ? 'var(--primary-offset)' : "transparent",
                  },
      ...
      >
        <ListItemButton
          ...
          sx={{
            ...
            "&.Mui-selected": {
              "&:hover": {
                backgroundColor:  selectedKey ==="/" ? 'var(--primary-offset)' : "transparent",
              },
              backgroundColor: selectedKey ==="/" ? "var(--primary)":"transparent",
            },
            justifyContent: "center",
            margin: '10px auto',
            borderRadius: "12px",
        ...
        >
          ...
          <ListItemText
            ...
            primaryTypographyProps={{
              ...
              fontSize: "16px",
              color: selectedKey ==="/" ? "#fff":"#808191",
              fontWeight: selectedKey === "/" ? "400" : "400",
            }}
          />
        </ListItemButton>
      </Tooltip>
